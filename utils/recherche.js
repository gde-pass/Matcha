            ...
            if (isFull != true && age1 != "undefined") {
                ...
                let users = results.filter(res => {
                    ...
                    if (orientation == 'Homosexual') {
                        if ((dist / 1000) >= distance1 && (dist / 1000) <= distance2 && res.age >= age1 && res.age <= age2 && gender == res.sex && orientation == res.orientation) {
                            return (true);
                        }
                    } else if (orientation == 'Bisexual') {
                        if ((dist / 1000) >= distance1 && (dist / 1000) <= distance2 && res.age >= age1 && res.age <= age2) {
                            return (true);
                        }
                    } else {
                        if ((dist / 1000) >= distance1 && (dist / 1000) <= distance2 && res.age >= age1 && res.age <= age2 && gender != res.sex && orientation == res.orientation) {
                ...
                let suggestion = results.filter(res => {
                    ...
                    if (res.tags != null) {
                        if (orientation == 'Homosexual') {
                            if ((dist / 1000) >= distance1 && (dist / 1000) <= distance2 && res.age >= age1 && res.age <= age2 && gender == res.sex && orientation == res.orientation && findTag(res.tags.split('#')) == 1) {
                                return (true);
                            }
                        } else if (orientation == 'bisexual') {
                            if ((dist / 1000) >= distance1 && (dist / 1000) <= distance2 && res.age >= age1 && res.age <= age2 && findTag(res.tags.split('#')) == 1) {
                                return (true);
                            }
                        } else {
